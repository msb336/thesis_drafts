...
As seen in the experimental meshing section, these parameters are not the be-all end-all of volumetric mesh compatibility, but they are definitely related to a mesh's ability to be converted to a solid volume.

\section{Finite Element Models of Meshes}
