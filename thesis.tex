...
The common usages for this equipment is for automated awareness and unmanned navigation, but there is much more that can be done with the data collected. Setting a precident for a way to convert point clouds collected by UAVs to solid models would be enormously helpful.
...
\begin{figure}[!ht]
	...
	\caption[Example of a high tier LiDAR sensor data output]{\centering Data collected from an HDL-32E LiDAR device \cite{velodyne}. } %[[latex doesn't like this citation]]
\end{figure}
...
\paragraph{Fairing}
The fairing algorithm smooths the newly refined surface into a continous shape based on a minimization of a linear bi-Laplacian system with boundary constraints \cite{meshfairing}. %[[what does this mean beyond being a wave interpolation function / be more specific]]
...
In order to resolve low quality areas autonomously, what it means to be "low quality" must be explicitly defined mathematically. Table~\ref{table:meshquality} lists some of the ratios to define a mesh's quality level. Low  quality  values  in  mesh  return  problematic  polyhedrons  for  volumetric  conversion,  typically  looking  like  those  shown  in  figure \ref{fig:meshquality}.
...
It is crucial to view the effects of noise on the control dataset, as 
...
The final verification of the meshes output by the algorith occurs in two stages. The first being a measure of each desired quality parameter to assure the mesh meets the criteria set in this paper. The second is an exportation of the mesh to AutoDesk Fusion, which has in-built functionality to convert surface meshes to boundary representations and subsequently finite element volumes. If both of these verifications are successful, the resulting mesh is placed under typical loading conditions to compare it's response to the expected response of the object.
...
\begin{table}[!ht]
	\centering
		...
		\begin{tabular}{ | c | c | c | c | c | c | c | c | }
			\hline
			 Mesh Type & $Q_{1}$ & $Q_{2}$ & $Q_{3}$ & $Q_{4}$ & Bounded Surfaces & Successful Conversion
			\\ \hline Advacing Front & 0.0548 & 0.2916 & 0.0270 & 0.0274 & 1 & Yes
			\\ \hline Scale Space 2  & 0.0577 & 0.0665 & 0.0082 & 0.0587 & 1 & No
			\\ \hline Scale Space 4  & 0.0038 & 0.0185 & 0.0005 & 0.0035 & 1 & No
			\\ \hline Scale Space 15 & 0.0022 & 0.0186 & 0.0002 & 0.0015 & 1 & No
			\\ \hline
	\end{tabular}}
...
\begin{table}[!ht]
	\centering
		...
		\begin{tabular}{ | c | c | c | c | c | c | c | c | }
			\hline
			 Mesh Type & $Q_{1}$ & $Q_{2}$ & $Q_{3}$ & $Q_{4}$ & Bounded Surfaces & Successful Conversion
			\\ \hline Initial Advacing Front & 0.0548 & 0.2916 & 0.0270 & 0.0274 & 1 & Yes
			\\ \hline Optimized Advancing Front & 0.3096 & 0.1910 & 1.333  & 0.1548 & 1 & Yes
			\\ \hline Initial Scale Space 2  & 0.0577 & 0.0665 & 0.0082 & 0.0587 & 1 & No
			\\ \hline Optimized Scale Space 2   & 0.0072 & 0.1085 & 0.0035 & 0.0037 & 1 & No
			\\ \hline Initial Scale Space 4  & 0.0038 & 0.0185 & 0.0005 & 0.0035 & 1 & No
			\\ \hline Optimized Scale Space 4   & 0.0031 & 0.0786 & 0.0016 & 0.0016 & 1 & No
			\\ \hline
	\end{tabular}}
	Quality values shown represent the absolute minima in each category.
...
\begin{table}[!ht]
	\centering
		...
		\begin{tabular}{ | c | c | c | c | c | c | c | c | }
			\hline
			 Mesh Type & $Q_{1}$ & $Q_{2}$ & $Q_{3}$ & $Q_{4}$ & Bounded Surfaces & Successful Conversion
			\\ \hline Advacing Front & 0.1518 & 0.0877 & 0.0133 & 0.0924 & 314	& No
			\\ \hline Scale Space 2  & 0.0402 & 0.0594 & 0.0088 & 0.0259 & 1	& Yes
			\\ \hline Scale Space 4  & 0.0080 & 0.0592 & 0.0035 & 0.0043 & 1	& No
			\\ \hline
	\end{tabular}}
	Quality values shown represent the absolute minima in each category.
...
\begin{table}[!ht]
	\centering
		...
		\begin{tabular}{ | c | c | c | c | c | c | c | c | }
			\hline
			 Mesh Type & $Q_{1}$ & $Q_{2}$ & $Q_{3}$ & $Q_{4}$ & Bounded Surfaces & Successful Conversion
			\\ \hline Initial Scale Space 2  	& 0.0402 & 0.0594 & 0.0088 & 0.0259 & 1	& Yes
			\\ \hline Optimized Scale Space 2 	& 0.1367 & 0.1077 & 0.0147 & 0.0955 & 1 & Yes
			\\ \hline Initial Scale Space 4  	& 0.0080 & 0.0592 & 0.0035 & 0.0043 & 1	& No
			\\ \hline Optimized Scale Space 4 	& 0.1166 & 0.1444 & 0.0552 & 0.0595 & 1 & Yes
			\\ \hline
	\end{tabular}}
	Quality values shown represent the absolute minima in each category.
...
\begin{table}[!ht]
	\centering
		...
		\begin{tabular}{ | c | c | c | c | c | c | c | c | }
			\hline
			 Mesh Type & $Q_{1}$ & $Q_{2}$ & $Q_{3}$ & $Q_{4}$ & Bounded Surfaces & Successful Conversion
			\\ \hline Advacing Front & 0.1446 & 0.1072 & 0.0419 & 0.0849 & 28	& No
			\\ \hline Scale Space 2  & 0.0175 & 0.0524 & 0.0066 & 0.0093 & 2	& No
			\\ \hline Scale Space 4  & 0.0117 & 0.0562 & 0.0057 & 0.0059 & 2	& No
			\\ \hline
	\end{tabular}}
	Quality values shown represent the absolute minima in each category.
...
\begin{table}[!ht]
	\centering
		...
		\begin{tabular}{ | c | c | c | c | c | c | c | c | }
			\hline
			 Mesh Type & $Q_{1}$ & $Q_{2}$ & $Q_{3}$ & $Q_{4}$ & Bounded Surfaces & Successful Conversion
			\\ \hline Initial Scale Space 2 	& 0.0175 	& 0.0524 & 0.0066 & 0.0093 	& 2	& No
			\\ \hline Optimized Scale Space 2 	& 0.2629  	& 0.1941 & 0.1099 & 0.1418 	& 2	& No

			\\ \hline Initial Scale Space 4  	& 0.0117	& 0.0562 & 0.0057 & 0.0059 	& 2	& No
			\\ \hline Optimized Scale Space 4 	& 0.2143	& 0.1229 & 0.0558 & 0.1087 	& 2 & No
			\\ \hline
	\end{tabular}}
	Quality values shown represent the absolute minima in each category.
...
\begin{table}[!ht]
	\centering
		...
		\begin{tabular}{ | c | c | c | c | c | c | c | c | }
			\hline
			 Mesh Type & $Q_{1}$ & $Q_{2}$ & $Q_{3}$ & $Q_{4}$ & Bounded Surfaces & Successful Conversion
			\\ \hline Optimized Scale Space 2 	& 0.2629  	& 0.1941 & 0.1099 & 0.1418 	& 1	& No
			\\ \hline Optimized Scale Space 4 	& 0.2143	& 0.1229 & 0.0558 & 0.1087 	& 1 & Yes
			\\ \hline
	\end{tabular}}
	Quality values shown represent the absolute minima in each category.
...
\begin{table}[!ht]
	\centering
		...
		\begin{tabular}{ | c | c | c | c | c | c | c | c | }
			\hline
			 			Mesh  			& $Q_{1}$ 	& $Q_{2}$ 	& $Q_{3}$ 	& $Q_{4}$ 	& Successful Conversion
			\\ \hline Zero noise AF 	& 0.3096	& 0.191		& 1.333		& 0.1548	& 1
			\\ \hline Zero noise SS2 	& 0.0072	& 0.1085	& 0.0035	& 0.0037	& 0
			\\ \hline Zero noise SS4	& 0.0031	& 0.0486	& 0.0016	& 0.0016	& 0
			\\ \hline 2cm noise SS2		& 0.1367	& 0.1077	& 0.0147	& 0.0955	& 1
			\\ \hline 2cm noise SS4		& 0.1166	& 0.1444	& 0.0553	& 0.0595	& 1
			\\ \hline Experimental SS2	& 0.2629	& 0.1941	& 0.1099	& 0.1418	& 0
			\\ \hline Experimental SS4	& 0.2143	& 0.1229	& 0.0558	& 0.1087	& 0
			\\ \hline
	\end{tabular}}
